...
SEARCH_SPACE = {
    ...
    "fusion_depth": [1, 2, 3],
    "fusion_gate": ["none", "se"],
    "plane_fusion": ["concat", "plane_attention", "plane_transformer"],
    ...
    "cache_size": [16, 32, 48],
    "num_workers": [0, 2, 4],
    "aug_policy": ["none", "light", "strong", "knee_mri", "knee_mri_plus"],
    "aug_noise_std": [0.0, 0.01, 0.02, 0.04],
    "aug_cutout_frac": [0.0, 0.08, 0.12, 0.18],
    "aug_slice_dropout": [0.0, 0.03, 0.06, 0.1],
    "aug_gamma_jitter": [0.0, 0.06, 0.12],
    "aug_spatial_shift_frac": [0.0, 0.02, 0.03],
    "loss_type": ["bce", "focal"],
    "focal_gamma": [1.0, 1.5, 2.0],
    "label_smoothing": [0.0, 0.02, 0.03, 0.05],
    "ema_decay": [0.0, 0.995],
    "val_tta_mode": ["none", "flip"],
    "plane_transformer_heads": [2, 4],
    "pretrained": [0, 1],
}
...
DEFAULT_CONFIG = {
    ...
    "aug_gamma_jitter": 0.0,
    "aug_spatial_shift_frac": 0.0,
    "loss_type": "bce",
    "focal_gamma": 2.0,
    "label_smoothing": 0.0,
    "ema_decay": 0.0,
